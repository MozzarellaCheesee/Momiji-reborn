...
class Profiles(Model):
    ...
    user: fields.ForeignKeyRelation["models.Users"] = fields.ForeignKeyField("models.Users", related_name="Profile",
                                                                             null=False)
    ...
    family: fields.ForeignKeyRelation["models.Families"] = fields.ForeignKeyField("models.Families",
                                                                                  related_name="Profile", null=True,
                                                                                  on_delete=fields.SET_NULL,
                                                                                  default=None)
    partner: fields.ForeignKeyRelation["models.Users"] = fields.ForeignKeyField("models.Users",
                                                                                related_name="Profile_p", null=True,
                                                                                on_delete=fields.CASCADE, default=None)
