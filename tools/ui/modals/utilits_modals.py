...
class ReportModal(Modal):
    ...
    async def callback(self, inter: ModalInteraction) -> None:
        ...
        await self.bot.channels.report_channel.send(embed=dev_embed, view=BlockButton(self.interaction.author, self.bot, dev_embed))
...
class IdeaModal(Modal):
    ...
    async def callback(self, inter: ModalInteraction) -> None:
        ...
        await inter.response.send_message(embed=user_embed, ephemeral=True, view=SupportButton())
        await self.bot.channels.idea_channel.send(embed=dev_embed, view=BlockButton(self.interaction.author, self.bot, dev_embed))